...
public class VehicleReport {
  ...
  /**
   * Being Time a timestamp (integer) in seconds identifying the time at which the position event
   * was emitted,
   */
   ...
   * 0 if it is an entrance ramp (ENTRY), 1 − 3 if it is a travel lane (TRAVEL) and 4 if it is an
   * exit ramp (EXIT)).
   */
  public int lane;
  /**
   * Dir: (0 . . . 1) indicates the direction (0 for Eastbound and 1 for Westbound) the vehicle is
   * traveling.
   */
